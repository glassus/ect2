...
!!! example "{{ exercice() }} : création de table "
    ...
    On souhaite créer une table ```tournoi``` concernant les joueurs de rugby du tournoi des VI nations 2026 et leur nombre de points marqués.
    ...
    **Q3.** Insérer dans cette table le joueur Thomas Ramos (France) qui a marqué 74 points. On lui attribuera un ```id_joueur``` égal à 1. 
    ...
    ??? success \"Correction\" 
        ```sql
        INSERT INTO tournoi
        VALUES (1, 'Ramos', 'Thomas', 'France', 74)
        ```        
    """
    )
    }}
    ...
    **Q4.** Afin de rajouter des joueurs dans cette table, copier-coller le code ci-dessous dans le champ SQL :
    ...
    INSERT INTO tournoi
    VALUES 
    (2, "Russell", "Finn", "Ecosse", 53),
    (3, "Crowley", "Jack", "Irlande", 47),
    (4, "Bielle-Biarrey", "Louis", "France", 45),
    (5, "Ford", "George", "Angleterre", 27),
    (6, "Edwards", "Dan", "Pays de Galles", 27),
    (7, "Attissogbe", "Théo", "France", 25),
    (8, "Garbisi", "Alessandro", "Italie", 21),
    (9, "Arundell", "Henry", "Angleterre", 20);
    ```
    ...
    Faire une requête pour afficher uniquement le nom et le prénom des joueurs français de cette table.
...
![image](data/good-luck.gif){: .center}
