...
Pour faire **réellement** de l'aléatoire, certaines entreprises utilisent des [astuces physiques](https://www.cloudflare.com/fr-fr/learning/ssl/lava-lamp-encryption/){. target="_blank"}.
...
!!! example "{{ exercice() }}"
    ...
    **Q1.** Calculer $u_2$ et $u_3$. Donner les résultats sous forme de fraction irréductible.
