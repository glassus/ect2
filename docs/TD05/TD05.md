# TD05 : Découverte du langage SQL


:warning: Avant de faire ces exercices, il faut avoir lu le [Cours de SQL](../../CoursSQL/programme_officiel/).
...
!!! abstract "{{ exercice() }}"
    *Extrait du sujet 0 Ecricome ECG Mathématiques Approfondies*
